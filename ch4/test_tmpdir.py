...
def test_tmdir(tmpdir):
    # tempdir already has a path name associated with it.
    # join() extends the path to include a filename.
    # the file is created when it's writen to.
    a_file = tmpdir.join("something.txt")

    # You can create directories.
    a_sub_dir = tmpdir.mkdir("anything")

    # You can create a file in directories(created when written).
